...
<head>
    ...
    <?php if( get_page_template_slug() == 'single.php'): echo '<link rel="stylesheet" href="' . get_stylesheet_directory_uri() . '/styles/single.css" />'; endif;?>
    <?php if( get_page_template_slug() == 'single.php'): echo '<script src="' . get_stylesheet_directory_uri() . '/scripts/gallery.js" ></script>'; endif;?>
