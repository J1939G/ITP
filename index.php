<?php 
    ...
    or die('Error connecting to server. Please contact site manager on jgredonsky@gmail.com');
	$lang = 'en';
    if (isset($_GET['lang'])) {
		$lang = $_GET['lang'];
		$langFlag = "?lang=" . $lang;
    ...
    mysqli_query($db, $query) or die('Error querying database. Please contact site manager on jgredonsky@gmail.com');
...
<html lang="en">
	...
	<body>
		<div id="content">
			...
			<a href="photography/<?php echo $langFlag ?>"><?php echo $row['linkB'] ?></a>
			<a href="stories/"><?php echo $row['linkC'] ?></a>
			<a href="contact/<?php echo $langFlag ?>"><?php echo $row['linkD'] ?></a>
			<div id="background">
